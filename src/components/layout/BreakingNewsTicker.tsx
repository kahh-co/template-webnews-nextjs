...
export default function BreakingNewsTicker({ beritaItems }: BreakingNewsTickerProps) {
  ...
  return (
    <div className="bg-red-600 dark:bg-red-700 text-white text-xs font-medium overflow-hidden border-b border-red-700/50">
          ...
          <div className="flex animate-marquee hover:[animation-play-state:paused] whitespace-nowrap gap-10">
            {beritaItems.concat(beritaItems).map((berita, idx) => (
              ...
              >
                ...
                <span className="font-semibold text-white/90 truncate max-w-sm sm:max-w-md md:max-w-none">
                  {berita.judul}
                </span>
